"""Pydantic models for all codexaudit data structures."""
...
class CodexAuditConfig(BaseModel):
    ...
    def db_path(self) -> Path:
        return self.effective_output_dir / "codexaudit.db"

    @property
    def effective_output_dir(self) -> Path:
        if self.output_dir:
            return self.output_dir
        return self.project_path / ".codexaudit"
