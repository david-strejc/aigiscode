...
from codexaudit.contracts import ContractLookup, build_contract_lookup
...
def _apply_finding_plugins(
    ...
    *,
    ...
    from codexaudit.extensions import apply_hardwiring_finding_plugins
...
def analyze_hardwiring(
    ...
    if external_plugins and project_path is not None:
        from codexaudit.extensions import apply_contract_lookup_plugins
